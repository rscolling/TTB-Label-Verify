...
| L3 Integration | Live Claude vision extraction against real sample label images; schema conformance; latency measured and asserted < 5s | pytest, gated: skip cleanly when ANTHROPIC_API_KEY absent | Yes |
